...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-marco-border bg-marco-bg/40">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 pt-10 sm:pt-16 pb-8 sm:pb-10">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 sm:gap-10 lg:gap-8 mb-10 sm:mb-12">
          <div className="lg:col-span-4">
            ...
            <button
              ...
              className="mt-6 inline-flex w-full sm:w-auto items-center justify-center rounded-xl bg-marco-accent px-6 py-3 text-[11px] font-medium uppercase tracking-[0.15em] text-marco-bg hover:bg-marco-accent-hover transition-all active:scale-[0.98]"
            >
              Оставить заявку
            </button>
          </div>
